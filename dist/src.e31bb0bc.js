...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"ProfileAPI.js":[function(require,module,exports) {
"use strict";
...
class ProfileAPI {
  async getProfiles() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/social"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
...
var _ProfileAPI = _interopRequireDefault(require("../../ProfileAPI"));
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n    <div class=\"tinder--card\">\n   <img slot=\"image\"\n    src=\"", "/images/", "\"\n    alt=\"", "\"\n  />\n  <p style=\"font-size:25px; color: #0365B0\"><b>", ", ", "</b></p>\n  <p class=\"card-location\">", "</p>\n  <p> By ", " ", "</p>\n    </div>\n          "]);
...
class socialView {
  ...
  async getProfiles() {
    try {
      this.profiles = await _ProfileAPI.default.getProfiles();
  ...
  async addFavHandler() {
    try {
      _UserAPI.default.addFavHaircut(this.id);

      _Toast.default.show('added to friends!');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.profiles == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.profiles.map(profile => (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, profile.avatar, profile.avatar, profile.petName, profile.petAge, profile.suburb, profile.user.firstName, profile.user.lastName))), this.addFavHandler.bind(this));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new socialView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../ProfileAPI":"ProfileAPI.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n          <sl-avatar shape=\"rounded\" style=\"--size: 800px; max-width:100%;margin-bottom: 1em;\" image=", "></sl-avatar>\n        "]);
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n                <sl-avatar shape=\"rounded\" style=\"--size: 100px;\" image=\"", "/images/", "\"></sl-avatar>\n                <input type=\"file\" name=\"avatar\" />\n              "]);
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["\n        <div class=\"profile-body\" style=\"max-width:100%\">\n<h1 class=\"edit-profile-heading\">Edit ", "'s Profile   <sl-icon name=\"person-circle\" style=\"font-size: 25px;color:white;\"></sl-icon></h1>\n\n<p style=\"color:#0365B0;\">Last updated: ", "</p>\n          <sl-form class=\"page-form\" @sl-submit=", ">\n          <div class=\"generic-card\"><h5 class=\"edit-list\">First Name</h5><div class=\"input-group\">\n              <sl-input type=\"text\" name=\"firstName\" value=\"", "\" placeholder=\"First Name\" pill clearable><sl-icon name=\"pencil-fill\" slot=\"suffix\"></sl-icon></sl-input>\n            </div></div>\n            <div class=\"generic-card\"><h5 class=\"edit-list\">Last Name</h5><div class=\"input-group\">\n              <sl-input type=\"text\" name=\"lastName\" value=\"", "\" placeholder=\"Last Name\" pill clearable>  <sl-icon name=\"pencil-fill\" slot=\"suffix\"></sl-icon></sl-input>\n            </div></div>\n            <div class=\"generic-card\"><h5 class=\"edit-list\">Email</h5><div class=\"input-group\">\n              <sl-input type=\"text\" name=\"email\" value=\"", "\" placeholder=\"Email Address\" pill clearable><sl-icon name=\"pencil-fill\" slot=\"suffix\"></sl-icon></sl-input>\n            </div>  </div>         \n            <div class=\"generic-card\"><h5 class=\"edit-list\">Bio</h5><div class=\"input-group\">\n            <sl-textarea type=\"text\" name=\"bio\" value=\"", "\" placeholder=\"bio\" pill></sl-textarea>\n          </div>  </div> \n          <div class=\"generic-card\"><h5 class=\"edit-list\">Pet Name</h5><div class=\"input-group\">\n          <sl-input type=\"text\" name=\"petName\" value=\"", "\" placeholder=\"petname\" pill clearable><sl-icon name=\"pencil-fill\" slot=\"suffix\"></sl-icon></sl-input>\n        </div>  </div> \n        <div class=\"generic-card\"><h5 class=\"edit-list\">Pet Age</h5><div class=\"input-group\">\n        <sl-input type=\"text\" name=\"petAge\" value=\"", "\" placeholder=\"petAge\" pill clearable><sl-icon name=\"pencil-fill\" slot=\"suffix\"></sl-icon></sl-input>\n      </div>   </div>\n      <div class=\"generic-card\"><h5 class=\"edit-list\">Suburb</h5><div class=\"input-group\">\n      <sl-input type=\"text\" name=\"suburb\" value=\"", "\" placeholder=\"suburb\" pill clearable><sl-icon name=\"pencil-fill\" slot=\"suffix\"></sl-icon></sl-input>\n    </div>    </div>\n  <div class=\"generic-card\"><h5 class=\"edit-list\">Account Type</h5><div class=\"input-group\">\n  <sl-radio-group label=\"Select an option\" name=\"account\" value=\"", "\">\n  <sl-radio-button value=\"Host\">Host</sl-radio-button>&nbsp;\n  <sl-radio-button value=\"Guest\">Guest</sl-radio-button>&nbsp;\n  <sl-radio-button value=\"Flexible\">Flexible</sl-radio-button>\n</sl-radio-group>\n</div></div>\n<div class=\"generic-card\">\n            <div class=\"input-group\">\n            <h5 class=\"edit-list\">Photo</h5><br>          \n              ", "\n            </div></div>\n            <p>&nbsp;</p>\n            <sl-button type=\"primary\" class=\"submit-btn\" submit>Update Profile</sl-button>\n          </sl-form>\n        "]);
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.user.petName, (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM'), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.email, this.user.bio, this.user.petName, this.user.petAge, this.user.suburb, this.user.accountType, this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5())));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/welcome.js":[function(require,module,exports) {
"use strict";
...
class TemplateView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, () => (0, _Router.gotoRoute)('/editProfile'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../UserAPI":"UserAPI.js"}],"HaircutAPI.js":[function(require,module,exports) {
"use strict";
...
class TemplateView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.haircuts == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.haircuts.map(haircut => (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, haircut.image, haircut._id, haircut.name, haircut.price, JSON.stringify(haircut.user), haircut.image))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/social.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Social\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1 style=\"float:left; color:white; margin-left:25px;\">Find a friend!</h1>\n        <div class=\"switch-button\">\n        <input class=\"switch-button-checkbox\" type=\"checkbox\"></input>\n        <label class=\"switch-button-label\" for=\"\"><span class=\"switch-button-label-span\"><h4>Visitor</h4></span></label>\n      </div>\n        <div class=\"tinder\">\n        <div class=\"nocards\">Oh no! There's no cards left :( </div>\n      ", "\n         <div class=\"tinder--buttons\">\n           <img class=\"profile-icon\" id=\"nope\" class=\"tinder-nope\" src=\"/images/dislike.png\">\n       <img class=\"profile-icon\" id=\"love\" class=\"tinder-love\" @click=", " src=\"/images/like.png\">\n       </div> </div>      \n    "]);
...
class socialView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.profiles == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.profiles.map(profile => (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, profile.avatar, profile.avatar, profile.petName, profile.petAge, profile.suburb, profile.user.firstName, profile.user.lastName, () => (0, _Router.gotoRoute)('/profile')))), this.addFavHandler.bind(this));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../ProfileAPI":"ProfileAPI.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/favouriteHaircuts.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Friends\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Arrange a playdate</h1>\n        <div class=\"haircuts-grid\">\n        ", "\n        </div>\n      </div>      \n    "]);
...
class favouriteHaircutsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.petFriends == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.petFriends.map(friend => (0, _litHtml.html)(_templateObject4(), friend._id))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new favouriteHaircutsView();
...
var _social = _interopRequireDefault(require("./views/pages/social"));

var _favouriteHaircuts = _interopRequireDefault(require("./views/pages/favouriteHaircuts"));
...
const routes = {
  ...
  '/favourites': _favouriteHaircuts.default
};
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/welcome":"views/pages/welcome.js","./views/pages/guide":"views/pages/guide.js","./views/pages/haircuts":"views/pages/haircuts.js","./views/pages/social":"views/pages/social.js","./views/pages/favouriteHaircuts":"views/pages/favouriteHaircuts.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n    <style>\n    .author {\n        font-size: .9em;\n        font-style: italic;\n        opacity: 0.8;\n        \n    }\n    </style>\n<div class=\"wrap\">\n<div class=\"image\">\n<img src=\"", "/images/", "\" alt=\"", "\"\n</div>\n<div class=\"content\">\n<h2>", "</h2>\n<h3>", "</h3>\n<p class=\"price\">", "</p>\n<p class=\"gender\">", "</p>\n<p class=\"length\">", "</p>\n\n<sl-icon-button name=\"heart-fill\" label=\"Add to Favourites\" @click=", ">Add to Favourites</sl-icon-button>\n</div>\n</div>\n    "]);
...
customElements.define('va-haircut', class Haircut extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.name, this.description, this.price, this.gender, this.length, this.addFavHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../Toast":"Toast.js","../UserAPI":"UserAPI.js"}],"components/va-profileCard.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-profilecard', class profileCard extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.image, this.petName, this.petAge, this.suburb, this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this), this.addFavHandler);
  }
...
require("./components/va-profileCard");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-haircut":"components/va-haircut.js","./components/va-profileCard":"components/va-profileCard.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
